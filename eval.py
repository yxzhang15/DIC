...
def train(args, net, train_loader, test_loader):
    ...
    scheduler = MultiStepLR(opt, milestones=[30,50], gamma=0.1)
...
def main():
    ...
    os.system('cp model_eval.py checkpoints' + '/' + args.exp_name + '/' + 'model_eval.py.backup')
